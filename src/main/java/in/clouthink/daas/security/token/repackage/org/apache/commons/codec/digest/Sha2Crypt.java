 ...
 */
package in.clouthink.daas.security.token.repackage.org.apache.commons.codec.digest;

import in.clouthink.daas.security.token.repackage.org.apache.commons.codec.Charsets;
...
public class Sha2Crypt {
     ...
     * @param algorithm
     *            {@link java.security.MessageDigest} algorithm identifier
     *            string
     * @return complete hash value including prefix and salt
     * @throws IllegalArgumentException
     *             if the given salt is <code>null</code> or does not match the
     *             allowed pattern
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is
     *             caught
     ...
     */
    private static String sha2Crypt(final byte[] keyBytes,
                                    final String salt,
        ...
        // itself without the enclosing '$', without the magic salt_prefix $5$
        // and
        ...
        // the terminating NUL in the C representation), add digest B to digest
        // A
        /*
        ...
        // 18. repeast the following 16+A[0] times, where A[0] represents the
        // first
        ...
        for (int i = 0; i <= rounds - 1; i++) {
            ...
            // d) for all round numbers not divisible by 3 add the byte sequence
            // S
            /*
            ...
            // e) for all round numbers not divisible by 7 add the byte sequence
            // P
            /*
        ...
        // int buflen = salt_prefix.length() - 1 + ROUNDS_PREFIX.length() + 9 +
        // 1 + salt_string.length() + 1 + 86 + 1;
        
        if (blocksize == 32) {
            B64.b64from24bit(altResult[0],
                             altResult[10],
                             altResult[20],
                             4,
                             buffer);
            B64.b64from24bit(altResult[21],
                             altResult[1],
                             altResult[11],
                             4,
                             buffer);
            B64.b64from24bit(altResult[12],
                             altResult[22],
                             altResult[2],
                             4,
                             buffer);
            B64.b64from24bit(altResult[3],
                             altResult[13],
                             altResult[23],
                             4,
                             buffer);
            B64.b64from24bit(altResult[24],
                             altResult[4],
                             altResult[14],
                             4,
                             buffer);
            B64.b64from24bit(altResult[15],
                             altResult[25],
                             altResult[5],
                             4,
                             buffer);
            B64.b64from24bit(altResult[6],
                             altResult[16],
                             altResult[26],
                             4,
                             buffer);
            B64.b64from24bit(altResult[27],
                             altResult[7],
                             altResult[17],
                             4,
                             buffer);
            B64.b64from24bit(altResult[18],
                             altResult[28],
                             altResult[8],
                             4,
                             buffer);
            B64.b64from24bit(altResult[9],
                             altResult[19],
                             altResult[29],
                             4,
                             buffer);
            ...
            B64.b64from24bit(altResult[0],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[22],
                             altResult[43],
                             altResult[1],
                             4,
                             buffer);
            B64.b64from24bit(altResult[44],
                             altResult[2],
                             altResult[23],
                             4,
                             buffer);
            B64.b64from24bit(altResult[3],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[25],
                             altResult[46],
                             altResult[4],
                             4,
                             buffer);
            B64.b64from24bit(altResult[47],
                             altResult[5],
                             altResult[26],
                             4,
                             buffer);
            B64.b64from24bit(altResult[6],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[28],
                             altResult[49],
                             altResult[7],
                             4,
                             buffer);
            B64.b64from24bit(altResult[50],
                             altResult[8],
                             altResult[29],
                             4,
                             buffer);
            B64.b64from24bit(altResult[9],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[31],
                             altResult[52],
                             altResult[10],
                             4,
                             buffer);
            B64.b64from24bit(altResult[53],
                             altResult[11],
                             altResult[32],
                             4,
                             buffer);
            B64.b64from24bit(altResult[12],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[34],
                             altResult[55],
                             altResult[13],
                             4,
                             buffer);
            B64.b64from24bit(altResult[56],
                             altResult[14],
                             altResult[35],
                             4,
                             buffer);
            B64.b64from24bit(altResult[15],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[37],
                             altResult[58],
                             altResult[16],
                             4,
                             buffer);
            B64.b64from24bit(altResult[59],
                             altResult[17],
                             altResult[38],
                             4,
                             buffer);
            B64.b64from24bit(altResult[18],
                             ...
                             4,
                             buffer);
            B64.b64from24bit(altResult[40],
                             altResult[61],
                             altResult[19],
                             4,
                             buffer);
            B64.b64from24bit(altResult[62],
                             altResult[20],
                             altResult[41],
                             4,
                             buffer);
