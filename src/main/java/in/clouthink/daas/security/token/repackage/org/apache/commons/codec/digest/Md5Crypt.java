 ...
 * Kamp which was found at: <a href=
...
public class Md5Crypt {
     ...
     *            plaintext string to hash.
     * @param salt
     *            salt string including the prefix and optionally garbage at the
     *            end. Will be generated randomly if null.
     * @return the hash value
     * @throws IllegalArgumentException
     *             if the salt does not match the allowed pattern
     * @throws RuntimeException
     ...
     * <p>
     * See {@link Crypt#crypt(String, String)} or
     * {@link #apr1Crypt(String, String)} for details.
     *
     * @param keyBytes
     *            plaintext string to hash.
     * @param salt
