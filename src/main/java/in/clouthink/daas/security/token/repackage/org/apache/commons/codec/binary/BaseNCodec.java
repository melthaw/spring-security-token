...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    protected final byte pad; // instance variable just in case it needs to vary
                              // later
    ...
    protected BaseNCodec(final int unencodedBlockSize,
        ...
        this.lineLength = useChunking ? (lineLength / encodedBlockSize) * encodedBlockSize
                                     : 0;
     ...
     * @param value
     *            The value to test
     * @return <code>true</code> if the value is defined in the current alphabet,
