...
import in.clouthink.daas.security.token.repackage.org.apache.commons.codec.binary.Hex;
import in.clouthink.daas.security.token.repackage.org.apache.commons.codec.binary.StringUtils;
...
public class DigestUtils {
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because MD2 is a
     *             built-in algorithm
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because MD5 is a
     *             built-in algorithm
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because SHA-1 is a
     *             built-in algorithm
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because SHA-256 is a
     *             built-in algorithm
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because SHA-384 is a
     *             built-in algorithm
     ...
     * @throws IllegalArgumentException
     *             when a {@link java.security.NoSuchAlgorithmException} is caught, which should never happen because SHA-512 is a
     *             built-in algorithm
     ...
     *             On error reading from the stream
     * @since 1.4
     * @deprecated Use {@link #sha1(java.io.InputStream)}
     */
    @Deprecated
     ...
     *             On error reading from the stream
     * @since 1.4
     * @deprecated Use {@link #sha1Hex(java.io.InputStream)}
     */
    @Deprecated
    ...
    /**
     * Updates the given {@link java.security.MessageDigest}.
     *
     * @param messageDigest
     *            the {@link java.security.MessageDigest} to update
     * @param valueToDigest
     *            the value to update the {@link java.security.MessageDigest} with
     * @return the updated {@link java.security.MessageDigest}
     * @since 1.7
     */
